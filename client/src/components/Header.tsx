        ...
        <>
            ...
            <div className='flex'>
                <div className='h-[calc(100vh-80px)] bg-gray-100 w-3/12 px-10'>
                    <ul>
                        <li className="my-5"><a href="/" className="text-xl">Home</a></li>
                        <li className="my-5"><a href="/" className="text-xl">Task Manager</a></li>
                        <li className="my-5"><a href="/" className="text-xl">Submit Task</a></li>
                        <li className="my-5"><a href="/" className="text-xl">Attendance</a></li>
                        <li className="my-5"><a href="/" className="text-xl">Logout</a></li>
                    </ul>
